...
cd ~/private-llm-src && git checkout <compat 之前的提交> -- vps/   # 或手改 nginx conf 去掉三个 = location
cd ~/private-llm-src/vps && ./deploy.sh                        # 重渲染 nginx，三条路径回直达 litellm
