...
ROWS = [
    ("08-15 14:32:05", "pi-local", "…Rg2Q", "deepseek-v4-flash-0731", "acompletion", 12480, 8192, 1024, 644, 3210, "198.51.100.7", "ok", ""),
    ("08-15 14:31:47", "justink", "…bGvw", "qwen3.6-35b-fp8", "messages", 830, 0, 246, 388, 1140, "192.0.2.20", "ok", ""),
    ("08-15 14:31:02", "pi-local", "…Rg2Q", "deepseek-v4-flash-0731", "acompletion", 44600, 39800, 5200, 1890, 18460, "198.51.100.7", "ok", ""),
    ("08-15 14:30:38", "home-only", "…Iag", "qwen3.6-35b-fp8", "acompletion", 2210, 512, 680, 410, 2205, "203.0.113.12", "ok", ""),
    ("08-15 14:29:55", "pi-local", "…Rg2Q", "claude-opus-5", "messages", 960, 0, 130, 0, 0, "198.51.100.7", "failure", "上游 connect_timeout=5s 超时（站点隧道中断）"),
    ("08-15 14:28:41", "justink", "…bGvw", "deepseek-v4-flash-0731", "acompletion", 1560, 768, 210, 512, 1430, "192.0.2.20", "ok", ""),
    ("08-15 14:27:19", "pi-local", "…Rg2Q", "deepseek-v4-flash-0731", "acompletion", 22180, 16400, 2800, 1210, 9930, "198.51.100.7", "ok", ""),
    ("08-15 14:26:58", "home-only", "…Iag", "qwen3.6-35b-fp8", "acompletion", 640, 0, 88, 350, 890, "203.0.113.12", "ok", ""),
    ("08-15 14:26:12", "justink", "…bGvw", "claude-opus-5", "messages", 1180, 0, 160, 0, 0, "192.0.2.20", "failure", "Anthropic 协议转换：400 model_not_found"),
    ("08-15 14:25:37", "pi-local", "…Rg2Q", "deepseek-v4-flash-0731", "acompletion", 3024, 1024, 410, 480, 2110, "198.51.100.7", "ok", ""),
]
...
<tr><td style="color:#8c8c8c">客户端 IP</td><td class="mono">198.51.100.7</td></tr>
